...
export default function Upload() {
    ...
    return (
        <div className="flex h-full">
            <Form.Root className="m-auto w-[340px]" autoComplete="off" onSubmit={(e: React.FormEvent) => submit(e, formState)} onChange={onChange}>
                <Form.Field className="grid mb-[10px]" name="title">
                    ...
                    <Form.Control asChild>
                        <input className="box-border w-full bg-white text-black shadow-blackA9 inline-flex h-[35px] appearance-none items-center justify-center rounded-[4px] px-[10px] text-lg leading-none shadow-[0_0_0_1px] outline-none hover:shadow-[0_0_0_1px_cornflowerblue] focus:shadow-[0_0_0_1px_cornflowerblue] selection:color-white selection:bg-blackA9"
                            required />
                    </Form.Control>
                </Form.Field>
                ...
                <Form.Submit asChild>
                    <button type="submit" className="box-border w-full text-violet11 shadow-blackA7 hover:bg-mauve3 inline-flex h-[35px] items-center justify-center rounded-[4px] bg-white px-[15px] font-medium leading-none shadow-[0_2px_10px] focus:shadow-[0_0_0_2px] focus:shadow-black focus:outline-none mt-[10px]">
                        Post question
                    </button>
                </Form.Submit>
